  ...
  slideDeck {
    ...
    val slide29 =
      slide(
        id = 29,
        title = "29th Decison",
        content = decision29Text,
      ) {
        choice(
          text = "Stay with the SS Fox",
          slide = slideSuccess,
        )
        choice(
          text = "Ask the captain when the ship will be departing",
          slide = errorSlide.copyOf("Incorrect1"),
        )
        choice(
          text = "Look for a new ship",
    ...
    val slide28 =
      slide(
        id = 28,
        title = "28th Decison",
        content = decision28Text,
      ) {
        choice(
          text = "Attempt to sneak onto a ship and stow away",
          slide = errorSlide.copyOf("Incorrect1"),
        )
        choice(
          text = "Attempt to find work on a ship heading north",
          slide = slide29,
        )
      }
    ...
    val slide27 =
      slide(
        id = 27,
        title = "27th Decison",
        content = decision27Text,
      ) {
        choice(
          text = "Use it despite your concerns",
          slide = errorSlide.copyOf("Incorrect1"),
        )
        choice(
          text = "Abandon the plan to use it",
          slide = errorSlide.copyOf("Incorrect2"),
        )
        choice(
    ...
    val slide25 =
      slide(
        id = 25,
        title = "25th Decison",
        content = decision25Text,
      ) {
        choice(
          text = "Stay with the minister all the way into the city",
          slide = errorSlide.copyOf("Incorrect1"),
        )
        choice(
          text = "After spending time with the minister, you tell him your true predicament, " +
              "that you are fugitive and ask him for help",
          slide = errorSlide.copyOf("Incorrect2"),
        )
        choice(
          text = "Slip away from the minister and head into the woods",
          slide = slide26,
        )
      }
    ...
    val slide24 =
      slide(
        id = 24,
        title = "24th Decison",
        content = decision24Text,
      ) {
        choice(
          text = "Tell this man of God you are a fugitive and seek his assistance",
          slide = errorSlide.copyOf("Incorrect1"),
        )
        choice(
          text = "Tell him you are off running errands for your master",
          slide = errorSlide.copyOf("Incorrect2"),
        )
        choice(
          text = "Tell him you were given the day off to go visit family on another plantation",
          slide = errorSlide.copyOf("Incorrect3"),
        )
        choice(
          text = "Tell him you were separated from your master who is headed for Savannah and you " +
    ...
    val slide23 =
      slide(
        ...
        choice(
          text = "Head to Savannah",
          slide = slide24,
        )
        choice(
          text = "Wait at the crossing and see if you can learn more about the options",
          slide = errorSlide.copyOf("Incorrect2"),
        )
      }
    ...
    val slide22 =
      slide(
        id = 22,
        title = "22nd Decison",
        content = decision22Text,
      ) {
        choice(
          text = "You have to take advantage of this opportunity, you attempt to steal the keys",
          slide = slide23,
        )
        choice(
          text = "You are worried you will get caught and you wait for a better opportunity",
          slide = errorSlide.copyOf("Incorrect1"),
        )
      }
    ...
    val slide21 =
      slide(
        id = 21,
        title = "21st Decison",
        content = decision21Text,
      ) {
        choice(
          text = "Stay put and see how this new situation unfolds",
          slide = slide22,
        )
        choice(
          text = "Talk to fellow Enslaved Africans to gather information about escaping in this new location",
          slide = errorSlide.copyOf("Incorrect1"),
        )
        choice(
          text = "Attempt to run away that evening",
          slide = errorSlide.copyOf("Incorrect2"),
        )
      }
    ...
    val slide20 =
      slide(
        id = 20,
        title = "20th Decison",
        content = decision20Text,
      ) {
        choice(
          text = "Seek the first opportunity to escape again",
          slide = errorSlide.copyOf("Incorrect1"),
        )
        choice(
          text = "Stay put for the time being",
          slide = slide21,
        )
      }
    ...
    val slide16 =
      slide(
        ...
        choice(
          text = "Look for downstream for a bridge or watercraft",
          slide = slide17,
        )
      }
    ...
    val slide15 =
      slide(
        id = 15,
        title = "15th Decison",
        content = decision15Text,
      ) {
        choice(
          text = "Find a place to hide and wait for your captors to move on",
          slide = errorSlide.copyOf("Incorrect1"),
        )
        choice(
          text = "Try and break the shackles, thus increasing your speed",
          slide = slide16,
        )
        choice(
          text = "Keep moving shackled together",
          slide = errorSlide.copyOf("Incorrect2"),
        )
      }
    ...
    val slide4 =
      slide(
        id = 4,
        title = "4th Decison",
        content = decision4Text,
      ) {
        choice(
          text = "You aren’t a strong swimmer, you head back the direction you came from",
          slide = errorSlide.copyOf("Incorrect1"),
        )
        choice(
          text = "Attempt to swim across the river",
          slide = errorSlide.copyOf("Incorrect2"),
        )
        choice(
          text = "Investigate along the shoreline and look for a place to wade across\n",
          slide = errorSlide.copyOf("Incorrect3"),
        )
        choice(
          text = "Head up river looking for either a bridge or a watercraft of some sort",
          slide = slide5,
        )
      }
    ...
    val slide3 =
      slide(
        id = 3,
        title = "3rd Decision",
        content = decision3Text,
      ) {
        choice(
          text = "This is not a good time to escape, you should wait and devise a better plan",
          slide = errorSlide.copyOf("Incorrect1"),
        )
        choice(
          text = "This is a great opportunity to escape, you can’t waste any time to remove the leg irons",
          slide = errorSlide.copyOf("Incorrect2"),
        )
        choice(
          text = "Remove the leg irons before attempting your escape",
          slide = slide4,
        )
      }
    ...
    val slide1 =
      slide(
        id = 1,
        title = "1st Decision",
        content = decision1Text,
      ) {
        choice(
          text = "Head back to the slave quarters and take your chances the rumor was false",
          slide = errorSlide.copyOf("Incorrect1"),
        )
        choice(
          text = "Run away right now",
          slide = slide2,
        )
        choice(
          text = "Wait until the night to escape",
          slide = errorSlide.copyOf("Incorrect2"),
        )
      }
